...
admin-panel-text = <b>Панель адміністратора</b>
admin-panel-keyboard =
  .distance-education-button = { $isDistanceEducation ->
    [true] ✅ Дистанційне навчання
    *[false] ❌ Дистанційне навчання
  }
admin-panel =
  .updated-distance-education-text = { $isDistanceEducation ->
    [true] Переведено у режим дистанційного навчання!
    *[false] Переведено у режим очного навчання!
  }